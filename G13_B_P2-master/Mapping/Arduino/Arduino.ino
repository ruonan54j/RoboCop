...
/*
    Radio control global varibles to communicate with the wireless controller
    Utilizes 3 libraries for communication.
    Addresses are to establish communication between the robot and controller.
 */
=======
// Radio control global varibles
>>>>>>> 77fa86f00a53cb538d7687c014b73df690f851e3
#include <SPI.h>
#include <nRF24L01.h>
#include <RF24.h>
...
/*
    These are all the functions used to control the stepper motors.
 */
...
/*
    Section which keeps track of the changes in distance and angle for
    the raspberry pi to keep track of the current coordinates.
 */
...
<<<<<<< HEAD
// void function which the remote control utilizes to control the robot.
// Switch statements to check what mode the remote is
void remoteControl(){

    // If there is a radio signal available; grab any signal from the transmitter
    if (radio.available()) {
        // Grab whats direction to go.
      ...
      if (payload_received.sw_state)
        ...
        //checks if the car collides. if it does; buzz the controller.
    ...
    // updates any changes to the Raspberry Pi
    // keeps track if the controller changes commands.
    ...
    // Turns headlights on if the car is moving.
